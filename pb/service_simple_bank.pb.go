...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xd6\x04\n" +
	"\n" +
	"SimpleBank\x12\x8b\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"N\x92A1\x12\x0fCreate new user\x1a\x1eUse this API create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x81\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"D\x92A'\x12\vUpdate user\x1a\x18Use this API update user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x9a\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"`\x92AD\x12\n" +
	"Login user\x1a6Use this API login user and get access & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x98\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"X\x92A=\x12\fVerify Email\x1a-Use this API to veridy users's email addrress\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x85\x01\x92A^\x12\\\n" +
	"\x0fSimple Bank Api\"D\n" +
	"\vEmre ÇOLAK\x12\x1fhttps://github.com/emrecolak-23\x1a\x14colakkemre@gmail.com2\x031.2Z\"github.com/emrecolak-23/go-bank/pbb\x06proto3"
